"""
Django settings for robots_46240 project.
...
ROOT_URLCONF = 'robots_46240.urls'
...
WSGI_APPLICATION = 'robots_46240.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "robots_46240 API",
    "DESCRIPTION": "API documentation for robots_46240 App",
    "VERSION": "v1",
}
